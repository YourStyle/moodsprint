export const translations = {
  ru: {
    ...
    orCustom: 'или своё значение',
    customMinutes: 'мин (5–120)',
    ...
    statStrength: 'Сила',
    statStrengthDesc: 'Увеличивает атаку и защиту',
    statDexterity: 'Ловкость',
    statDexterityDesc: 'Увеличивает скорость и атаку',
    statIntelligence: 'Интеллект',
    statIntelligenceDesc: 'Увеличивает защиту и HP',
    speed: 'Скорость',
    winsCount: '{count} побед',
    lossesCount: '{count} поражений',
  ...
  en: {
    ...
    orCustom: 'or custom value',
    customMinutes: 'min (5–120)',
    ...
    statStrengthDesc: 'Increases attack and defense',
    statDexterity: 'Dexterity',
    statDexterityDesc: 'Increases speed and attack',
    statIntelligence: 'Intelligence',
    statIntelligenceDesc: 'Increases defense and HP',
    speed: 'Speed',
    winsCount: '{count} wins',
    lossesCount: '{count} losses',
