...
export function CampaignContent() {
  ...
  if (showLevelSelect && selectedChapter) {
    return (
      <div className="space-y-4">
        ...
        >
          ...
          <span className="text-sm">Назад к главам</span>
        </button>
              ...
              >
                <div className="p-4 flex items-center gap-4">
                  <div className={cn(
                    ...
                    level.is_boss ? 'bg-red-600/30' : 'bg-gray-700/50'
                  )}>
                    {level.is_boss ? (
    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <Card className="text-center py-8">
          ...
          <p className="text-gray-400">Кампания скоро появится</p>
        </Card>
      ) : (
