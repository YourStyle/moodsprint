...
ВАЖНО: Если в описании есть СПИСОК (товары, пункты, действия через запятую) —
ВСЕГДА разбивай на шаги, НИКОГДА не возвращай no_new_steps!

КОНТЕКСТНОЕ ПОНИМАНИЕ:
- Если задача про ПОКУПКИ и в описании СПИСОК ТОВАРОВ — создай ОТДЕЛЬНЫЙ шаг для КАЖДОГО товара!
...
- Используй свои знания чтобы ОБОГАТИТЬ задачу, НО НЕ РАЗДУВАЙ простые задачи без списков!

ПРИМЕРЫ ПРАВИЛЬНОГО РАЗБИЕНИЯ:
- "Купить лекарства" + "аспирин, бинт, зелёнка" → 3 шага по одному на товар
- "Купить продукты" + "молоко, хлеб, яйца, сыр, масло" → 5 шагов, по одному на каждый товар
- "Подготовить презентацию" → 4-5 шагов от структуры до финала
- Если товаров много (10+) — можно группировать по категориям
